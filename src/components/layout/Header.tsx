  ...
  return (
    <div className="relative w-full">
      ...
      <div className="hidden md:flex justify-center items-center space-x-8 pt-2 py-6 bg-white">
        <a href="#inicio" className="text-gray-500 font-normal text-sm">
          INICIO
        </a>
        <a href="#new-collection" className="text-gray-500 font-normal text-sm">
          NEW COLLECTION
        </a>
        <div
        ...
        <a href="#sale" className="text-gray-500 font-normal text-sm">
          SALE
        </a>
      </div>
